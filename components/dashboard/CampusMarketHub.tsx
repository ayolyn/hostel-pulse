        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h1 className="text-xl sm:text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tight">Campus Market</h1>
                ...
                <button 
                    ...
                    className="relative z-10 flex items-center justify-center gap-2 bg-[#BEF264] text-black px-6 py-3 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-[#a6d456] transition-all shadow-lg shadow-[#BEF264]/20 hover:-translate-y-0.5 active:translate-y-0"
                >
            ...
            <div className="flex items-center justify-center p-6 sm:p-24 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center text-center max-w-xl mx-auto">
                    ...
                    <h2 className="text-xl sm:text-2xl sm:text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-6 uppercase tracking-tight leading-tight">
