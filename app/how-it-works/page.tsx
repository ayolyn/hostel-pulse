    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black/90 text-gray-900 dark:text-gray-100 pt-32 pb-16 px-4 sm:px-6 lg:px-4">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight sm:text-3xl sm:text-2xl sm:text-3xl lg:text-3xl sm:text-4xl text-gray-900 dark:text-white mb-4">
        ...
        <div className="mt-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Step 1 */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-5 text-center hover:shadow-md transition-shadow">
        ...
        <div className="mt-20 bg-[#16a34a] dark:bg-[#BEF264] rounded-3xl p-6 md:p-8 text-center shadow-xl">
          <h2 className="text-xl sm:text-2xl font-extrabold text-white dark:text-gray-900 mb-6">
          ...
          <button className="bg-white dark:bg-gray-900 text-[#16a34a] dark:text-[#BEF264] px-4 py-3 rounded-full font-bold text-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors shadow-sm">
            Start Exploring
          </button>
        </div>
      </div>
