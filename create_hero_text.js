...
const heroTextComponent = `"use client";
...
`;
fs.writeFileSync('components/home/AnimatedHeroText.tsx', heroTextComponent, 'utf8');

console.log('Created AnimatedHeroText.tsx');
