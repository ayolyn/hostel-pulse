...
// Reduce font size
page = page.replace(
    'className="text-[2.5rem] leading-[1.1] sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-4"',
    'className="text-4xl leading-[1.1] sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter mb-4"'
);
...
console.log('Fixed hero section style, font size, and copy in LandingPageClient');
