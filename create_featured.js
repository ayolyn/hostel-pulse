...
const featuredContent = `"use client";
...
fs.writeFileSync('components/home/FeaturedListings.tsx', featuredContent, 'utf-8');
console.log('Created FeaturedListings component');
